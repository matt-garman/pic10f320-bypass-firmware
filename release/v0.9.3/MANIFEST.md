...
- **Version / tag:** v0.9.3
- **Source commit:** `30951fde92f1838e6c623b4f019cf16cecafa258`
- **Built:** 2026-07-06T21:38:02Z by `matt` on `Linux 6.12.33-production+truenas x86_64`
...
| `bypass_mcu_tmux4053-simple_pic10f320.hex` | PIC10F320 | 2 MHz (INTOSC) | 217 words / 256 | CONFIG word embedded in HEX | `7798808d3a52398acc9883b8db7c998276009ecb18f5b8ed93ae2d76287be04b` |
...
| `bypass_mcu_tmux4053-mute_pic10f320.hex` | PIC10F320 | 2 MHz (INTOSC) | 240 words / 256 | CONFIG word embedded in HEX | `4f93b7bb05faa1f4ce1f3bd0b56a0ead72e44536fa9c7e3eb047554391b36adf` |
...
sha256sum -c release/v0.9.3/SHA256SUMS
```
